                ...
                ?>
                    ...
                    ?>
                        <div class="post-content">
                            <div class="row">
                                <div class="col-md-4">
                                    <a class="post-img" href="single.php?id=<?php echo $row['post_id']; ?>"><img src="admin/upload/<?php echo $row['post_img']; ?>" style="width:100%;height:100%;"/></a>
                                </div>
                                <div class="col-md-8">
                                    <div class="inner-content clearfix">
                                        ...
                                        <div class="post-information">
                                            ...
                                            <span>
                                                ...
                                                <a href='author.php?search=<?php echo $row['author']; ?>'><?php echo $row['first_name']." ".$row['last_name']; ?></a>
                                            </span>
                                            <span>
                        ...
                        <?php 
                            ...
                            $sql1 = "SELECT * FROM post WHERE title LIKE '%{$search_term}%' OR post.description LIKE '%{$search_term}%'"; 
